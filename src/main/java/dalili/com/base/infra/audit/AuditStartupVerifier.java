...
import dalili.com.base.infra.audit.anchoring.AnchorService;
...
public class AuditStartupVerifier implements ApplicationRunner {
    ...
    @Value("${dalili.audit.skip-verification:false}")
    ...
    public void run(ApplicationArguments args) {
        // Allow skipping verification for development/recovery scenarios
        if (skipVerification) {
            log.warn("AUDIT VERIFICATION SKIPPED - This should only be used for development or recovery scenarios");
            return;
        }
