    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/queue/*/hold").hasAnyRole("NURSE", "ADMIN")
                                .requestMatchers("/api/queue/*/resume").hasAnyRole("NURSE", "ADMIN")
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/encounters/dashboard/clinical")
                                .hasAnyRole("PHYSICIAN", "NURSE", "ADMIN", "SUPER_ADMIN")
                                .requestMatchers(HttpMethod.GET, "/api/encounters/dashboard/physician")
                                .hasAnyRole("PHYSICIAN", "NURSE", "ADMIN", "SUPER_ADMIN")
